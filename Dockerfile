FROM docker.io/nvidia/cuda:12.3.2-base-ubuntu22.04
...
RUN apt-get install -y cmake curl git-core build-essential libgl1-mesa-glx ffmpeg python3-pip wget zip
...
RUN cp /opt/vulkan/${VULKAN_SDK_VERSION}/x86_64/share/vulkan/explicit_layer.d/VkLayer_*.json /usr/local/share/vulkan/explicit_layer.d \
